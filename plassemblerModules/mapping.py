...
def index_fasta(fasta,  logger):
    ...
    try:
        ...
        plassemblerModules.write_to_log(bwa_index.stdout, logger)
    except:
...
def minimap_long_reads(chromosome_flag, out_dir, threads, logger):
    ...
    try:
        ...
        plassemblerModules.write_to_log(minimap.stderr, logger)
    except:
...
def bwa_map_short_reads(out_dir, chromosome_flag, threads, logger):
    ...
    try:
        ...
        plassemblerModules.write_to_log(bwa_map.stderr, logger)
    except:
